...
library NFTPositionInfo {
  /// @param factory The address of the Sushi V3 Factory used in computing the pool address
  ...
  /// @return pool The address of the Sushi V3 pool
  /// @return tickLower The lower tick of the Sushi V3 position
  /// @return tickUpper The upper tick of the Sushi V3 position
  ...
  function getPositionInfo(
    ...
    pool = IUniswapV3Pool(
      PoolAddress.computeAddress(address(factory), PoolAddress.PoolKey({token0: token0, token1: token1, fee: fee}))
    );
  }
}
